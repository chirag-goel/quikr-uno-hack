    ...
    <div class="row-gree">
      ...
      <div class="w-container wrap">
        ...
        <div class="center">
          ...
          <h2 class="underline">Donation</h2>



          <h5>Enter Donation Item</h5>
      ...
      <div class="w-container center">
        ...
        <div class="row">
         ...
         <?php 
            ...
            $dbhandle = mysqli_connect("mysql.hostinger.in", "u323038233_uno", "unouno","u323038233_quikr");



          // $db = mysqli_select_db($dbhandle,);
                ...
                <li class="mix web_design mix_all">
                     ...
                     <a class="image-popup-no-margins"  alt="responsive" title="Responsive Design" href="images/portfolio/thumbnail-01.jpg">
                        ...
                        <span>
                          ...
                          <h4 class="underline heading-description"><?= $row["name"]?></h4>



                          <p class="center description"><?= $row["location"]?></p>
