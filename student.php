...
<!-- END HEADER -->
  ...
  <div id="portfolio" class="student-products">
    ...
    <div class="row-gree">
      ...
      <div class="w-container wrap">
        ...
        <div class="center">
          ...
          <h2 class="underline">Student Products</h2>
    ...
    <li class="filter button border medium our-magic" data-filter="our_magic">Our Magic</li>
    <li class="magic">Renters from your college shown first</li>
