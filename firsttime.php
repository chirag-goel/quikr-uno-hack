...
<div class="signIn-bg">
	...
	<div class="login-page">
		...
		<div class="top">
			Please fill a few more details
		</div>
		<form method="POST" action="firsttime.php">
      <input type="text" name="name" placeholder="name"><br/>
			<input type="text" name="number" placeholder="Phone Number"><br/>
			<input type="email" name="email" placeholder="email"><br/>
      Please select your college (if student):
      <select name="college">
        <option value="PESIT - Bangalore South Campus">PESIT - Bangalore South Campus</option>
        <option value="RVCE">RV College of Engineering</option>
        <option value="NITK">NIT Suratkal</option>
        <option value="MIT">Manipal Insittute of Technology</option>
      </select>
...
<script type="text/javascript">
 ...
 oa.src = '//try01.api.oneall.com/socialize/library.js'
 var s = document.getElementsByTagName('script')[0];
 s.parentNode.insertBefore(oa, s)
</script>
<script type="text/javascript">
 var _oneall = _oneall || [];
 _oneall.push(['social_login', 'set_callback_uri', 'http://www.quikr-uno.esy.es/verify.php']);
...
<!-- 510099ba-d015-49a8-858f-3547cfbab805 -->
