...
$(document).ready(function(){
  ...
  $(".our-magic").click(function(){
    $(".options ul li.magic").css("display","inline-block");
  });
  ...
  $('#student-search-box').keyup(function() {
      var dInput = this.value;
      var city = $("#city").val();
      // alert(city + dInput);
      if($(".show-all").hasClass("active") || $(".our-magic").hasClass("active")) {
        $.ajax({
        method: "POST",
        url: "categoryStudent.php",
